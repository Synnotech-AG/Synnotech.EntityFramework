    ...
    where TDbContext : DbContext
{
    ...
    protected AsyncTransactionalSession(TDbContext context, bool disableQueryTracking = false, IsolationLevel? isolationLevel = null) : base(context, disableQueryTracking, isolationLevel) { }
    ...
    public Task<IAsyncTransaction> BeginTransactionAsync(CancellationToken cancellationToken = default)
    {
        ...
        return Task.FromResult<IAsyncTransaction>(new AsyncEfTransaction(transaction));
    }
}